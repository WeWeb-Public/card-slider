  ...
  computed: {
    ...
    columnWidth() {
      return {
        ...
        sm: {
          width: `calc(${
            100 / Math.min(this.section.data.thumbnailsPerLine, 2)
          }% - 30px)`,
        },
        md: {
          width: `calc(${
            100 / Math.min(this.section.data.thumbnailsPerLine, 3)
          }% - 30px)`,
        },
        lg: {
          width: `calc(${
            100 / Math.min(this.section.data.thumbnailsPerLine, 4)
          }% - 30px)`,
        },
      };
    },
